        ...
        {sortedTeam.length === 0 ? (
          ...
          sortedTeam.map((prof: any) => (
            <div
              ...
              className="flex items-center justify-between bg-slate-900/50 p-3 rounded-lg border border-slate-700/50 hover:border-cyan-500/50 transition-colors"
            >
              ...
              <div className="text-right">
                <p className="text-sm font-mono text-cyan-400 font-bold">
                  ...
                  {prof.nextAppointment
                    ? new Date(prof.nextAppointment).toLocaleDateString(
                        'es-ES',
      ...
      <div className="bg-cyan-900/20 border border-cyan-500/30 rounded-lg p-3 flex items-start gap-3">
        ...
        <div>
          ...
          <p className="text-[10px] text-slate-400 mt-1">
            Al finalizar tu próxima sesión, recuerda solicitarle a tu
            especialista que te asigne tus puntos Nexus correspondientes.
          </p>
        </div>
      </div>
    </AtlasCard>
