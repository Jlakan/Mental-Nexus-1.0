...
patientName: string;
userProfessionId?: string; // Hacemos opcional por si acaso, pero idealmente debe venir
}
...
}, [selSubCat, userProfessionId, missionType]); // Agregamos missionType para recargar si cambia el switch
  ...
  try {
    ...
    const assignmentData = {
      ...
      rewards: {
        ...
        statValue: tierData.stats || 0 // Ojo: en gameRules.ts usaste 'stats' o 'statValue', verifica el nombre exacto en tu archivo rules.
      },
    ...
    // Aquí separamos físicamente las colecciones según tu requerimiento
              ...
              {WEEKDAYS.map(day => {
                ...
                return (
                  <button
                    ...
                    style={{
                      width:'40px', height:'40px', borderRadius:'50%', border:'none', cursor:'pointer', fontWeight:'bold',
